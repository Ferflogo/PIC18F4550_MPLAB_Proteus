 ...
 * Author: FernandoFG
 *
 * Created on 14 de marzo de 2020, 10:37 AM
 * 
 * Este archivo se genera automaticamente en la pestana de:
 *      Window -> Target Memory Views -> Configuration Bits
 * Esto genera una plantilla con la configuracion de los pines.
 * 
 * En este archivo se configuraron lo siguiente:
 *      * PLLDIV 5 (PLL Prescaler Selection bits (Divide by 5 (20 MHz oscillator input))
 *      * FOSC HSPLL_HS Oscillator Selection bits (HS(High Speed) oscillator, PLL enabled (HSPLL))
